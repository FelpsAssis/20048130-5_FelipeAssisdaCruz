    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-white mb-5">
            <div class="container-fluid navbar-content">
                ...
                <a class="navbar-brand" href="?page=home"> <img src="images/logo2.png" alt="Logo" class="img-rresponsive logo" /> </a>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link <?= $page == 'Página inicial' ? 'active' : null ?>" aria-current="page" href="?page=home">Página inicial</a>
                    </li>
                    <li class="nav-item">
